...
class SCAILAutoExtend:
        ...
        return {
            "required": {
                ...
                "seed_mode": (["fixed", "increment"], {"default": "fixed",
                              "tooltip": "fixed: same seed every chunk for stable tone/identity. increment: chunk i uses noise_seed+i and may change tone."}),
            ...
            "optional": {
                ...
                "temporal_color_alpha": ("FLOAT", {"default": 0.95, "min": 0.0, "max": 0.99, "step": 0.01,
                    "tooltip": "EMA strength for temporal subject tone smoothing. Higher = more stable, lower = follows lighting changes faster."}),
                "temporal_color_strength": ("FLOAT", {"default": 0.90, "min": 0.0, "max": 1.0, "step": 0.01,
                    "tooltip": "Blend strength of the tone-smoothed subject back into the generated subject."}),
    ...
    def generate(self, model, positive, negative, vae, sampler, sigmas, pose_video,
                 ...
                 temporal_color_alpha=0.95, temporal_color_strength=0.90,
